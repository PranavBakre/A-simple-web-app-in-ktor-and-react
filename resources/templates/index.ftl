...
<html>
    ...
    <body style="background: Url(/static/background.jpg); height=1vh">
        ...
        <div class="container">
            <div class="row">
                    <div class="col-8 offset-2 col-sm-7 col-md-4 offset-md-8 bg-white justify-content-center" style="height:400px">
                        <a class="btn btn-outline-primary btn-block mt-2" href="/login">Sign in With Google</a>
                    </div>
            </div>
        </div>
    </body>
