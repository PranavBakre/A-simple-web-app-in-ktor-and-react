...
export const addressReducer= (state=initState, action) => {
    switch(action.type) {
        ...
        case AddressConsts.LOAD_USER_ADDRESSES_SUCCESS:
            return {...state,addressesLoading:false, addresses:action.payload,error:null}
        case AddressConsts.LOAD_USER_ADDRESSES_FAILURE:
            return {...state,addressesLoading:false, addresses:null,error:action.payload}
        ...
        case AddressConsts.DELETE_USER_ADDRESS_SUCCESS:
            return {...state,address:null, error:null, addresses:action.payload}
