                    ...
                    <Container>
                        <Row>
                            <Col className="justify-content-center pt-3">
                                <Switch>
                                    <AuthenticatedRoute path="/home/profile" component={Profile}></AuthenticatedRoute>
                                    <AuthenticatedRoute path="/home/address" component={Address}></AuthenticatedRoute>
                                </Switch>
                            </Col>
                            <Col md={{ size: 4, order: "end" }} className="justify-content-center pt-3 d-none d-md-block">
                                <Card>
                                    <CardHeader>
                                        <CardTitle>
