            ...
            <Col className="justify-content-center bg-white ">
              ...
              >
                <Row className="justify-content-center">
                  ...
                  <FormGroup
                    className="col-12 col-md-5 offset-md-1  justify-content-center"
                  >
                ...
                <Row className="justify-content-center">
                  <FormGroup
                    className="form-group col-12 col-md-5  justify-content-center"
                  >
                    ...
                    <Input
                      ...
                      disabled={this.state.profile["profile-lock"]}
                    />
                  </FormGroup>
                  <FormGroup
                    className="form-group col-12 col-md-5 offset-md-1  justify-content-center"
                  >
                ...
                <Row
                  ...
                  hidden={!this.state.profileChange}
                  id="profileSubmit"
                >
...
export default withRouter(
  connect(mapStateToProps, { LoadUserProfile, UpdateUserProfile })(Profile),
);
